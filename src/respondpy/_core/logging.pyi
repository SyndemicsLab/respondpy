...
import typing
__all__: list[str] = ['CreationStatus', 'LogType', 'create_file_logger', 'kDebug', 'kError', 'kExists', 'kInfo', 'kNotCreated', 'kSuccess', 'kWarn', 'log_debug', 'log_error', 'log_info', 'log_warning']
