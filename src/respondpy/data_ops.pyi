...
import numpy
import typing
__all__ = ['Cost', 'CostLoader', 'DataFormatter', 'DataLoader', 'Dimension', 'History', 'OutputType', 'Totals', 'UtilityLoader', 'UtilityType', 'Writer', 'WriterType', 'create_matrix3d', 'kCost', 'kDemographicCombo', 'kFile', 'kHistory', 'kInput', 'kIntervention', 'kMin', 'kMult', 'kOud', 'kOutput', 'kString', 'kTotals', 'kUtilities', 'mult_timed_matrix3d_by_double', 'mult_timed_matrix3d_by_matrix', 'print_matrix3d', 'print_timed_matrix3d', 'sum_timed_matrix3d', 'sum_timed_matrix3d_over_dimensions', 'vec_min_matrix3d', 'vec_mult_matrix3d']
class Cost:
    fatal_overdose_cost: dict[int, numpy.ndarray[numpy.float64[..., ..., ...]]]
    healthcare_cost: dict[int, numpy.ndarray[numpy.float64[..., ..., ...]]]
    non_fatal_overdose_cost: dict[int, numpy.ndarray[numpy.float64[..., ..., ...]]]
    perspective: str
...
class Dimension:
    ...
    Members:
      ...
      kDemographicCombo
    """
    __members__: typing.ClassVar[dict[str, Dimension]]  # value = {'kIntervention': <Dimension.kIntervention: 0>, 'kOud': <Dimension.kOud: 1>, 'kDemographicCombo': <Dimension.kDemographicCombo: 2>}
    kDemographicCombo: typing.ClassVar[Dimension]  # value = <Dimension.kDemographicCombo: 2>
    kIntervention: typing.ClassVar[Dimension]  # value = <Dimension.kIntervention: 0>
    ...
    def value(self) -> int:
        ...
class History:
    fatal_overdose_history: dict[int, numpy.ndarray[numpy.float64[..., ..., ...]]]
    intervention_admission_history: dict[int, numpy.ndarray[numpy.float64[..., ..., ...]]]
...
class OutputType:
    ...
    Members:
      ...
      kFile
    """
    __members__: typing.ClassVar[dict[str, OutputType]]  # value = {'kString': <OutputType.kString: 0>, 'kFile': <OutputType.kFile: 1>}
...
class WriterType:
    ...
    Members:
      ...
      kTotals
    """
    __members__: typing.ClassVar[dict[str, WriterType]]  # value = {'kInput': <WriterType.kInput: 0>, 'kOutput': <WriterType.kOutput: 1>, 'kHistory': <WriterType.kHistory: 2>, 'kCost': <WriterType.kCost: 3>, 'kUtilities': <WriterType.kUtilities: 4>, 'kTotals': <WriterType.kTotals: 5>}
    ...
    kUtilities: typing.ClassVar[WriterType]  # value = <WriterType.kUtilities: 4>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
